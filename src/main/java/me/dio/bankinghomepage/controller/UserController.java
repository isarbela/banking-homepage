package me.dio.bankinghomepage.controller;
...
import me.dio.bankinghomepage.controller.dto.UserDto;
...
public record UserController(UserService userService) {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get user by ID", description = "Retrieve specific user based on its ID")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Operation successful"),
    ...
    @PutMapping("{id}")
    @Operation(summary = "Update a user", description = "Update data of an existing user based in its ID")
    @ApiResponses(value = {
